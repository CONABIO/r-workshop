...
![Esquema de una base de datos](aux/schema_1.jpg)
...
![Esquema de una base de datos real](aux/schema_2.png)
...
lo ejemplificaremos con __RJDBC__. La información que se requiere para hacer la
...
# 1. Creo un objeto tipo Driver (paso adicional).
drv <- JDBC(driverClass = "com.microsoft.sqlserver.jdbc.SQLServerDriver", 
  classPath = "~/sqljdbc_4.0/enu/sqljdbc4.jar", identifier.quote="`")
